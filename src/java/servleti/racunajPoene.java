...
public class racunajPoene extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String brojKarata = request.getParameter("brKarata");
        String sifraFilma = request.getParameter("sifraFilma");

        int SifraKorisnika = Integer.parseInt(sifraKorisnika);
        int BrojKarata = Integer.parseInt(brojKarata);
        int SifraFilma = Integer.parseInt(sifraFilma);
        ...
        try {
            ...
            String upit = "UPDATE korisnik SET brojPoena = brojPoena + ? WHERE idKorisnika = ?";

            PreparedStatement ps = con.prepareStatement(upit);
            ps.setInt(1, BrojKarata);
