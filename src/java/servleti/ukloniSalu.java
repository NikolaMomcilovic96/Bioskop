...
public class ukloniSalu extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int idSale = Integer.parseInt(salaID);
        ...
        try {
            ...
            String upit = "DELETE FROM sala WHERE idSale = ?";
            ...
            request.setAttribute("msg", "Uspesno ste obrisali salu");
