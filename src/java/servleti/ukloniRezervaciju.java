...
public class ukloniRezervaciju extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String upit = "DELETE FROM rezervacija WHERE idRezervacije = '" + Sifra + "'";
            ...
            request.setAttribute("msg", "Uspesno ste uklonili rezervaciju");
