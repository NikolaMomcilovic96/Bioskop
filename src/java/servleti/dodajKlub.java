...
public class dodajKlub extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (naziv != null && naziv.length() > 0
            ...
            try {
                ...
                String upit = "INSERT INTO klub(nazivKluba, opisPogodnosti, popust) VALUES (?,?,?)";
                ...
                try {
                    ...
                    request.getRequestDispatcher("dodajKlub.jsp").forward(request, response);
                }
                request.setAttribute("msg", "Uspesno ste dodali klub");
