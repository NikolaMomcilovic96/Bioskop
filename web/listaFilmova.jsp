<%-- 
    ...
    Created on : Apr 17, 2020, 6:12:42 PM
    Author     : nikola
--%>
        ...
        <div class="container">
            <div class="row">
                ...
                <div id="sredina" class="col-xl-8 bg-secondary rounded">
                    <h1 id="naslov" align="center">Trenutni filmovi na repertoaru</h1>
                    ...
                    <div class="row" align="center">
                        ...
                        <div class="col-md-3">
                            <form action="listaFilmova" method="post">
                                <button type="submit" class="btn btn-md">Trenutno na repertoaru</button>
                            </form>
                        </div>
                        <div class="col-md-1"></div>
                        <div class="col-md-3">
                            <form action="uskoroFilmovi" method="post">
                                <button type="submit" id="uskoro" class="btn btn-md bg-dark">Uskoro na repertoaru</button>
                            </form>
                        </div>
                        <div class="col-md-2"></div>
